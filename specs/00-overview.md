...
| 5 | Zod placement | `defineActorWithSchema()` | Schema bound at machine definition time, flows through all APIs automatically |
...
```
ngx-xstate
├── defineActorWithSchema(machine, schemas)   → SchematizedActor<T>
